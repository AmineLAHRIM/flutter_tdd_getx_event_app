...
class _EventDetailScreenState extends State<EventDetailScreen> {
  final EventDetailController controller = Get.put(getIt<EventDetailController>());
  bool isInit = true;
  ...
  void didChangeDependencies() {
    ...
    if (isInit) {
      ...
      controller.setupCurrentEvent(id);
    }
    isInit = false;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Obx(() {
          var currentEvent = controller.currentEvent.value;
          if (currentEvent != null) {
            print('setupCurrentEvent Obx not Null');
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    var currentUsers = currentEvent.users ?? [];
            ...
            print('setupCurrentEvent Obx Null');
          }
          return Center(
            child: CircularProgressIndicator(),
          );
